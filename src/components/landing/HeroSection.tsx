  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-hero-gradient">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Floating shapes */}
        <motion.div
          className="absolute top-[20%] left-[15%] w-20 h-20 rounded-2xl bg-primary/5 backdrop-blur-sm border border-primary/10"
          animate={{ y: [-10, 10, -10], rotate: [0, 10, 0] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute top-[35%] right-[20%] w-16 h-16 rounded-full bg-primary/5 backdrop-blur-sm border border-primary/10"
          animate={{ y: [10, -10, 10], rotate: [0, -10, 0] }}
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 1 }}
        />
        <motion.div
          className="absolute bottom-[25%] left-[25%] w-12 h-12 rounded-xl bg-primary/5 backdrop-blur-sm border border-primary/10"
      ...
      <div className="container relative z-10 px-6 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-display font-normal tracking-tight mb-6"
          >
            Automate your
            <br />
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative px-8 py-4 bg-primary text-primary-foreground font-medium rounded-2xl shadow-button overflow-hidden transition-all duration-300 hover:shadow-glow"
            >
              <span className="relative z-10 flex items-center gap-2">
                Join the Waitlist
                <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
              </span>
              <div className="absolute inset-0 bg-gradient-to-r from-primary to-synth-blue-light opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </motion.button>
        ...
        >
          <div className="relative aspect-[16/9] rounded-3xl overflow-hidden glass-strong shadow-card">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-synth-blue-light/10" />
